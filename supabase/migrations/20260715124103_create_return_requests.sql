...
CREATE INDEX idx_return_requests_requester
ON public.return_requests(requester_id);

CREATE INDEX idx_return_requests_status
ON public.return_requests(status);

CREATE INDEX idx_return_requests_requested
ON public.return_requests(requested_at);
